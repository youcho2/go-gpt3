...
func (c *Client) CreateFile(ctx context.Context, request FileRequest) (file File, err error) {
	...
	req, err := http.NewRequest(http.MethodPost, c.fullURL("/files"), &b)
	if err != nil {
		return
	}
...
func (c *Client) DeleteFile(ctx context.Context, fileID string) (err error) {
	req, err := http.NewRequest(http.MethodDelete, c.fullURL("/files/"+fileID), nil)
	if err != nil {
		return
	}
...
func (c *Client) ListFiles(ctx context.Context) (files FilesList, err error) {
	req, err := http.NewRequest(http.MethodGet, c.fullURL("/files"), nil)
	if err != nil {
		return
	}
